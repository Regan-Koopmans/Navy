...
\begin{document}
	...
	\section{Introduction}
		...
		\begin{itemize}
			\item Students and employees who are searching for a particular building on campus, or are
		...
		\subsection{Scope}
			...
			occupies time and mental energy that might be otherwise better spent otherwise.
	...
	\section{Overall Description}
		...
		\subsection{Assumptions and Dependencies}
			...
			\begin{itemize}
				...
				make the assumption that the mobile devices will always have internet connectivity, in the 
				event that connectivity is momentarily lost, current path information may not be discarded.
				\item We can assume that all locations either to or from, will remain within the campus boundaries.
